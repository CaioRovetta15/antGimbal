...
def DHRobot(d1 = 0.18061, d2 = 0.00665, a1= -0.00654 , a2=0.0, alpha1=math.pi/2, alpha2=0,offset1=-math.pi/2,offset2=0):
    Link1 = rtb.RevoluteDH(alpha=alpha1, a=a1, d=d1,offset=offset1)
    Link2 = rtb.RevoluteDH(alpha=alpha2, a=a2, d=d2,offset=offset2)
    name="gimbal_robot"
...
def inverse_kinematics(robot,robot_base):
